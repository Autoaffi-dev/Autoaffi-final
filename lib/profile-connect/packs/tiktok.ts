...
const tiktok: PlatformPack = {
  platform: "tiktok",
  steps: {
    positioning: [
      {
        id: "tt_positioning_beast_v3",
        step: "positioning",
        title: "Choose your TikTok profile setup",
        subtitle:
        ...
        copy_blocks: [
          {
            ...
            paste_target: "Paste into your TikTok profile name",
          ...
          },
          {
            ...
            paste_target: "Paste into your TikTok bio intro / profile line",
    ...
    photo: [
      {
        id: "tt_photo_beast_v3",
        step: "photo",
        title: "Choose your TikTok profile image path",
        subtitle:
        ...
        copy_blocks: [
          {
            ...
            paste_target: "Use as your TikTok profile image direction",
    ...
    bio: [
      {
        ...
        copy_blocks: [
          {
            ...
            text: `Helping people find the right products, systems and next steps for individual growth.\nDM "START" ✅`,
            paste_target: "Paste into your TikTok bio",
        ...
        completion_requirements: [
          ...
          "Paste it into your TikTok bio field.",
        ],
      },
    ],
    ...
    link: [
      {
        id: "tt_link_beast_v3",
        step: "link",
        title: "Choose your TikTok link setup",
        subtitle:
    ...
    pinned: [
      {
        id: "tt_pinned_beast_v3",
        step: "pinned",
        title: "Choose your 3 pinned TikTok assets",
        subtitle:
        ...
        copy_blocks: [
          {
            ...
            text: "Create a pinned video that explains the page and welcomes new visitors.",
            paste_target: "Use as your first pinned video",
            helper: "This is your START asset.",
          },
          {
            label: "Pin 2 Direction",
            text: "Create a pinned video that makes the profile feel more trustworthy and easier to understand.",
            paste_target: "Use as your second pinned video",
            helper: "This is your PROOF asset.",
          },
          {
            label: "Pin 3 Direction",
            text: "Create a pinned video that tells people what the next step is and makes action feel easy.",
            paste_target: "Use as your third pinned video",
    ...
    cta: [
      {
        id: "tt_cta_beast_v3",
        step: "cta",
        title: "Choose your TikTok reply system",
        subtitle:
    ...
    final_kit: [
      {
        id: "tt_final_kit_beast_v3",
        step: "final_kit",
        title: "TikTok Final Kit",
