...
const instagram: PlatformPack = {
  platform: "instagram",
  steps: {
    positioning: [
      {
        id: "ig_positioning_beast_v3",
        step: "positioning",
        title: "Choose your Instagram profile setup",
        subtitle:
        ...
        copy_blocks: [
          {
            ...
            paste_target: "Paste into your Instagram name field",
          ...
          },
          {
            ...
            paste_target: "Paste into your bio intro / profile line",
    ...
    photo: [
      {
        id: "ig_photo_beast_v3",
        step: "photo",
        title: "Choose your Instagram profile image path",
        subtitle:
          "Use your own photo, use a faceless prompt, or use a ready-made visual.",
        instructions: [
          "Your image should make the page feel more worth clicking.",
        ...
        copy_blocks: [
          {
            ...
            paste_target: "Use as your Instagram profile image direction",
    ...
    bio: [
      {
        id: "ig_bio_beast_v3",
        step: "bio",
        title: "Choose your Instagram bio",
        subtitle:
        ...
        copy_blocks: [
          {
            ...
            text: `Helping people find the right products, systems and next steps for individual growth.\nDM "START" ✅`,
            paste_target: "Paste into your Instagram bio",
        ...
        completion_requirements: [
          ...
          "Paste it into your Instagram bio field.",
        ],
      },
    ],
    ...
    link: [
      {
        id: "ig_link_beast_v3",
        step: "link",
        title: "Choose your Instagram link setup",
        subtitle:
    ...
    proof: [
      {
        ...
        copy_blocks: [
          {
            ...
            text: "Use easy highlight titles and short trust text so the profile feels clearer and more beginner-friendly.",
            paste_target: "Use for your trust / highlight setup",
        ...
        completion_requirements: [
          ...
          "Use the trust titles and trust text in your highlights / featured content.",
        ],
      },
    ],
    ...
    pinned: [
      {
        id: "ig_pinned_beast_v3",
        step: "pinned",
        title: "Choose your 3 pinned Instagram assets",
        subtitle:
          "Autoaffi gives you the text and visual direction for your most important pinned content.",
        instructions: [
          "Pin 1 explains the page.",
          "Pin 2 builds trust.",
          "Pin 3 tells people what to do next.",
        ],
        copy_blocks: [
          {
            label: "Pin 1 Direction",
            text: "Create a pinned post that explains the page and welcomes new visitors.",
            paste_target: "Use as your first pinned post",
            helper: "This is your START asset.",
          },
          {
            label: "Pin 2 Direction",
            text: "Create a pinned post that makes the profile feel more trustworthy and easier to understand.",
            paste_target: "Use as your second pinned post",
            helper: "This is your PROOF asset.",
          },
          {
            label: "Pin 3 Direction",
            text: "Create a pinned post that tells people what the next step is and makes action feel easy.",
            paste_target: "Use as your third pinned post",
    ...
    cta: [
      {
        id: "ig_cta_beast_v3",
        step: "cta",
        title: "Choose your Instagram reply system",
        subtitle:
    ...
    final_kit: [
      {
        id: "ig_final_kit_beast_v3",
        step: "final_kit",
        title: "Instagram Final Kit",
